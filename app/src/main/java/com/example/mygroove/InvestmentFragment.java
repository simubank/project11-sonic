...
public class InvestmentFragment extends Fragment {
    ...
    public class InvestmentPreview {
        ...
        public void IPMatch(View view, MainActivity main) {
            ...
            if (optns.containsKey(none_s)) termPref = 2;
            else termPref = 1;
            ...
            if (riskRank == 1) {
                ...
                if (termPref == 1) {
                    ...
                    this.add(TDSTBF, TDDGF_L, TDSTBF_S);
